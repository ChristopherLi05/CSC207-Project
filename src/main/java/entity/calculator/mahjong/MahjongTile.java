...
public enum MahjongTile {
    ...
    GREEN_DRAGON("gd", "/tile/Hatsu.png", MahjongSuit.DRAGON, -1),
    RED_DRAGON("rd", "/tile/Chun.png", MahjongSuit.DRAGON, -2),
    WHITE_DRAGON("wd", "/tile/Haku.png", MahjongSuit.DRAGON, -3),
    EAST_WIND("ew", "/tile/Ton.png", MahjongSuit.WIND, -1),
    SOUTH_WIND("sw", "/tile/Nan.png", MahjongSuit.WIND, -2),
    WEST_WIND("ww", "/tile/Shaa.png", MahjongSuit.WIND, -3),
    NORTH_WIND("nw", "/tile/Pei.png", MahjongSuit.WIND, -4);
