...
public class PuzzleRushHandInteractor implements PuzzleRushHandInputBoundary {
    ...
    private final String[] hands = {
            ...
            "1m1m1m2m2m2m3m3m3m7m  4m5m6m 7m 6m 9m ew ew 1" // 12000
    };
    ...
    public void execute(int timeLeft, int currScore) {
        ...
        int newState = (int) (Math.random() * hands.length);
        if (newState == lastSeen) {
            newState = (newState + 1 ) % hands.length;
        }
        lastSeen = newState;
        String randomHand = hands[newState];
