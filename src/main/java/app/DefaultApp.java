 ...
 */
public class DefaultApp extends JFrame implements App {
     ...
     */
    public DefaultApp(String title) {
        this(title, new DefaultUserManager(), new InMemoryDataAccessor(), new HandStateFactory(), new ViewManager());
    }
     ...
     *
     * @param title            the title of the application window
     * @param userManager      the {@link UserManager} instance for user management
     ...
     */
    public DefaultApp(String title, UserManager userManager, DataAccessor dataAccessor, IHandStateFactory handStateFactory, ViewManager viewManager) {
        super(title);
